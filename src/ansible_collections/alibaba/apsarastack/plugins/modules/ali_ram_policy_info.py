...
def list_policies(module, ram_conn, policy_name, policy_id=None):
    if policy_id:
        return True
    params = {
    ...
    try:
        ...
        return module.fail_json(msg="Failed to list_policies: {0}".format(e))
...
def main():
    ...
    try:
        policies = list_policies(module, ram_connect(module), name_prefix)
